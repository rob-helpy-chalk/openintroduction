...
\label{ver_var} You can learn more about this in the chapters on critical thinking in extended version of this textbook. \nix{If your instructor assigns Part \ref{part:CT_and_informal_logic} of this text, which covers critical thinking, you will find} 
...
\begin{exercises}
\item England is smaller than China. \answer{\underline{Statement}}
\item Greenland is south of Jerusalem. \answer{\underline{Statement}}
\item Is New Jersey east of Wisconsin? \answer{\underline{A question, not a Statement.}}
\item The atomic number of helium is 2. \answer{\underline{Statement}}
\item The atomic number of helium is $\pi$. \answer{\underline{Statement}}
\item I hate overcooked noodles. \answer{\underline{Statement}}
\item Blech! Overcooked noodles! \answer{\underline{An exclamation, not a statement.}}
\item Overcooked noodles are disgusting.\answer{\underline{Statement}}
\item Take your time. \answer{\underline{A command, not a Statement}}
\item This is the last question. \answer{\underline{Statement}}
\end{exercises}
...
\item \textit{Henry is lamenting to his friend Bill}. I can't stand it any more. I'll tell you why: I'm tired of living all alone. No one ever calls me on the phone. And my landlady tried to hit me with a mop. (Based on Lou Reed's ``I Can't Stand It,'' from \textit{Lou Reed}.) 

\answer{\vspace{6pt}
Either an expository passage or an explanation. It is definitely not an argument, because Henry does not need to prove to Bill that he can't take it. Bill will immediately accept that Henry is unhappy, because they are friends. \\

The passage most closely resembles the ``Kelly is driving me insane'' example, earlier, which we said was an expository passage. On the other hand, the phrase "I'll tell you why" indicates that there is reasoning going on here. So you could view it as an explanation. There is often a gray area between expositions and explanations.\\

\begin{tikzpicture}
\path
	(0,0) node [anchor=west] {1. I'm tired of living all alone.}
	(0,-11pt) node [anchor=west]{2. No one ever calls me on the phone}
	(0,-22pt) node [anchor=west]{3. My landlady tried to hit me with a mop.}
	(9,-30pt) node [anchor=west]{E}
	(0,-41pt) node[anchor=west] {4. I can't stand it anymore.};
\draw (.5,-30pt) -- (9,-30pt);
\end{tikzpicture}
}
