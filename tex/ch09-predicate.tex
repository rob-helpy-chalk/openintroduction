...
\label{chap:QL}
\markright{Chap. \ref{chap:QL}: Quantified Logic}
...
% ********************************************
% * SECTION 5.1   From Sentences to Predicates   *
% ********************************************
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% SECTION 5.2 Building Blocks of QL %%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%	Practice problems for 4.2. %%%%%%
\practiceproblems
\setlength{\parindent}{0em}

\problempart Which of the following are terms in English?

% Rob: I added these based on a test I gave SP10.
\begin{multicols}{2}
...
\problempart Of the singular terms in \textbf{Part A}, which were proper names and which were definite descriptions?
...
% **********************
% * 5.4 Translating to QL   *
% **********************

\section{Translating to Quantified Logic}
...
%%%%%%5.4.2 Picking a Universe of Discourse %%%%%%%
...
\practiceproblems
%%  Rob: These are just moved from the end of the original chapter 5. They are all by Magnus. 
\setlength{\parindent}{0em}
...
\problempart
\label{pr.BarbaraEtc}
\iflabelexists{chap:cat_syllogisms}{Our language QL is an expanded and more powerful way of dealing with the categorical syllogisms, we studied in Chapter \ref{chap:cat_syllogisms}. Here are a few of the valid forms we looked at on page \pageref{table:full_twentyfour}.}{Our language QL is an expanded and more powerful way of dealing with a class of arguments that were originally studied by Aristotle known as categorical syllogisms. Aristotle's followers in the Latin medieval world developed a system of naming for the valid syllogisms that were known to them. These arguments and their names are listed below.} Translate each into QL. 
...
% rob: I moved this section earlier so that we can get a formal definition of wffs and sentences, as well as the discussion of freedom and bondage before we get to any of the tricky stuff, which some teachers might even want to skip. 
...
Some formal languages treat a wff like $Lzz$ as implicitly having a universal quantifier in front. We will not do this for QL. If you mean to say that everyone loves themselves, then you need to write the quantifier: $\forall zLzz$
...
%%%%%%%%%%%%%%%%			5.5.5		Substitution Instance			%%%%%%%%%%%%%%%%%

If \script{A} is a wff, $c$ a constant, and $x$ a variable, then $\script{A}[c|x]$ is the wff made by replacing each occurance of $x$ in \script{A} with $c$. This is called a \define{substitution instance} of $\forall x\script{A}$ and $\exists x\script{A}$; $c$ is called the \define{instantiating constant}.

For example: $Aa \eif Ba$, $Af \eif Bf$, and $Ak \eif Bk$ are all substitution instances of $\forall x(Ax \eif Bx)$; the instantiating constants are $a$, $f$, and $k$, respectively. $Raj$, $Rdj$, and $Rjj$ are substitution instances of $\exists zRzj$; the instantiating constants are $a$, $d$, and $j$, respectively.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%SECTION 5.6 Tricky Translations %%%%%%%%%%%%%%%%% 
\section{Tricky Translations}

%Rob: I created this section by separating off four subsections from the ``Translating to QL'' section. They were all sections I thought were more difficult. Giving them a separate section allowed me to do some practice problems before the hard stuff comes. 


\subsection{Ambiguous predicates}
%%%%%%%%%%%%%%%%%%%%%%%%%%SECTION 5.6.1 Ambiguous Predicates %%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%Section 5.6.2 Multiple quantifiers %%%%%%%%%%%%%%%%%%%%%%%%
...
% rob: The above paragraph is no longer needed then this section is moved here. 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%SECTION 5.6.4 Quantifiers and Scope %%%%%%%%%%%%%%%%
...
\practiceproblems
%%%%%%%%%%%%%			Practice problems for 5.6                   %%%%%%%%%%%%%%%%%%%%
% These are all taken from the original chapter on QL
\setlength{\parindent}{0em}
...
For a more detailed discussion of Russell's theory of definite descriptions, including objections to it, see the Peter Ludlow's entry ``descriptions'' in \emph{The Stanford Encyclopedia of Philosophy} \cite{Ludlow2004}, which is available free online. 
...
% rob: The above is from Magnus. I have no idea what he is on about.
%\solutions
%\problempart
%\label{pr.wiffQL}
...
%Note how this draws on some chapter 2 knowledge, like ``only'' and ``unless'' and ``but.'' Create an exercises that draws on these for 5.4 as a part of generally sequencing the arguments more carefully. 
