...
\have{5}{P} \ce{2, 4}
\close
\have{6}{\enot S \eif P} \by{\eif I}{3-5}
\end{proof}
}
...
\have{5}{K} \ae{1}
\close
\have{6}{K \eiff L} \by{\eiff E}{2-3, 4-5}
\end{proof}
}
...
\hypo{1}{\enot (P \eiff Q)} \by{Want: $P \eiff \enot Q$}{}
	...
	\close
	\open
	\hypo{11}{\enot Q} \by{Want: P}{}
		\open
		\hypo{12}{\enot P} \by{Want: A contradiction}{}
			\open
			\hypo{13}{P} \by{Want: Q}{}
			\have{14}{P \eor Q} \by{\eor I}{13}
			\have{15}{Q} \by{\eor E}{12, 14}
			\close
			\open
			\hypo{f}{Q} \by{Want: P}{}
			...
			\close
		\have{i}{P \eiff Q} \by{\eiff I}{13-15, f-h}
		\have{j}{\enot (P \eiff Q)} \by{R}{12}
		\close
	\have{21}{P} \by{\enot I}{11-j}
	\close
...
\answer{
	\begin{proof}
		...
		\open
		\hypo{1}{P} \by{Want: P \eor (Q \eand P)}{}
		\have{2}{P \eor (Q \eand P)} \by{\eor I}{1}
		\close
		\open
		\hypo{3}{P \eor (Q \eand P)} \by{Want: P}{}
			\open
			\hypo{4}{\enot P} \by{For reductio. Want: a contradiction}{}
			\have{5}{Q \eand P}		\by{\eor E}{3, 4}
			\have{6}{P} \by{\eand E}{5}
			\have{7}{~P}			\by{R}{4}
			\close
		\have{8}{P	} \by{\enot E}{4-8}			
		\close
	\have{9}{P \eiff (P \eor (Q \eand P))} \by{\eiff I 1-2, 3-8}{}
...
\answer{
\begin{proof}
\hypo{1}{A \eor A} \by{Want: A}{}
	\open
	\hypo{2}{\enot A} \by{Want: A contradiction}{}
	\have{3}{A} \by{\eor E}{1, 2}
	\have{4}{\enot A} \by{R}{2}
	\close
\have{5}{A} \by{\enot E}{2-4}
\end{proof}
}
...
\answer{
\begin{proof}
\hypo{1}{A} \by{Want B \eif A}{}
\open
\hypo{2}{B} \by{Want A}{}
\have{3}{A} \by{R}{1}
\close
\have{4}{B \eif A} \by{\eif I}{2-3}
\end{proof}
}
...
\answer{
It is valid. If you know that \script{A} on its own implies \script{B}, then a proof of $(\script{A}\eand\script{C})\sststile{}{}\script{B}$ would only require \eand E and then the proof that $\script{A}\sststile{}{}\script{B}$
}
...
\answer{
You do not know whether it is valid or now, because you no longer can assume that \script{A} is true.
}
...
\answer{We aren't going to want to use a 32 line truth table, so let's do a proof from no premises. Fortunately, it turns out that this problem is just a special case of the weakening theorem

\begin{quote}
\begin{proof}
	\open
	\hypo{1}{A}	\by{Want: $((B \eand C) \eor D) \eif A$}{}
	\have{2}{((B \eand C) \eor D) \eif A} \by{WK 1}{}
	\close
\have{3}{A \eif [((B \eand C) \eor D) \eif A]} \ci{1-2}
\end{proof}
\end{quote}
}
...
\answer{
\begin{longtabu}{cccc|cccccc}
B & \eif & \enot & S	&  \enot	&	\enot	&  B & \eif & \enot & S 	\\ \hline
T	&	F	&	F		&	T	&		T	&		F	&	T	&	F	&	F		&	T	\\
T	&	T	&	T		&	F	&		T	&		F	&	T	&	T	&	T		&	F	\\
F	&	T	&	F		&	T	&		F	&		T	&	F	&	T	&	F		&	T	\\
F	&	T	&	T		&	F	&		F	&		T	&	F	&	T	&	T		&	F	\\
...
\answer{An 8 line truth table is doable, but it would still be easier and more fun to do this as a derivation

\begin{proof}
\hypo{1}{\enot(A \eor B)}
\hypo{2}{C} 
\hypo{3}{C \eif A}  	\by{Want: A contradiction}{}
\have{4}{A} \ci{2, 3}
\have{5}{A \eor B} \oi{4}
\have{6}{\enot(A \eor B)} \by{R 1}{}
\end{proof}
}
...
\answer{
\begin{proof}
\hypo{1}{\enot(A \eor (B \eor C))} \by{Want: $\enot C$}{}
\have{2}{\enot A \eand \enot (B \eor C)} \by{DeM 1}{}
\have{3}{\enot A \eand (\enot B \eand \enot C)} \by{DeM 2}{}
\have{4}{\enot B \eand \enot C} \ae{3}
\have{5}{\enot C} \ae{3}
\end{proof}
}
