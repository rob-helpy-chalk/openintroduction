...
Formally, we can define a \define{sentence form} as a sentence in SL that contains one or more metavariables in place of sentence letters. A \define{substitution instance} of that sentence form is then a sentence created by consistently substituting sentences for one or more of the metavariables in the sentence form. Here ``consistently substituting'' means replacing all instances of the metavariable with the same sentence. You cannot replace instances of the same metavariable with different sentences, or leave a metavariable as it is, if you have replaced other metavariables of that same type. An \define{argument form} is an argument that includes one or more sentence forms, and a \define{substitution instance} of the argument form is the argument obtained by consistently replacing the sentence forms in the argument form with their substitution instances.
...
%	\begin{enumerate}[label=\alph*.]
%	\item $P \eor Q$
%	\item \framebox{$(A \eif B) \eand C$}
%	\item \framebox{\begin{flushleft}$[(A \eand B) \eif (B \eand A)] \eand (\enot A \eand \enot B)$\end{flushleft}}
%	\item \framebox{$[((A \eand B) \eand C) \eand D] \eand F$}  
%	\item $(A \eand B) \eif C$
%	\end{enumerate}
...
%2) $\enot(\script{P} \eand \script{Q})$
%\begin{enumerate}[label=\alph*., topsep=0pt, parsep=0pt, itemsep=3pt]
%	\item \framebox{$\enot(A \eand B)$}
%	\item \framebox{$\enot(A \eand A)$}
%	\item $\enot A \eand B$
%	\item \framebox{$\enot((\enot A \eand B) \eand (B \eand \enot A))$}
%	\item $\enot(A \eif B)$
%	\end{enumerate}
...
%	\begin{enumerate}[label=\alph*.]
%	\item $\enot A \eif B$
%	\item \framebox{$\enot (A \eif B)$}
%	\item \framebox{$\enot[(G \eif (H \eor I)) \eif G]$}
%	\item $\enot G \eand (\enot B \eand \enot H)$
%	\item \framebox{$\enot(G \eand (B \eand H))$}
%	\end{enumerate}
%\vspace{1em}
&
...
%(4) $\enot \script{A} \eif  \script{B}$
%	\begin{enumerate}[label=\alph*.]
%	\item $\enot A \eand B$
%	\item \framebox{$\enot B \eif A$}
%	\item \framebox{$\enot(X \eand Y) \eif (Z \eor B)$}
%	\item $\enot(A \eif B)$
%	\item $A \eif \enot B$
%	\end{enumerate}
...
\item $\enot \script{A} \eiff \enot \script{Z}$
	...
	\end{enumerate}
%(5) $\enot \script{A} \eiff \enot \script{Z}$
%	\begin{enumerate}[label=\alph*.]
%	\item $\enot (P \eiff Q)$
%	\item \framebox{$\enot(P \eiff Q) \eiff \enot (Q \eiff P)$}
%	\item $\enot H \eif \enot G$
%	\item $\enot (A \eand B) \eiff C$
%	\item \framebox{$\enot [\enot (P \eiff Q) \eiff R] \eiff \enot S$ }
%	\end{enumerate}
...
%6) $(\script{A} \eand \script{B}) \eor \script{C}$
%	\begin{enumerate}[label=\alph*.]
%	\item $(P \eor Q) \eand R$
%	\item \framebox{$(\enot M \eand \enot D) \eor C$}
%	\item $(D \eand R) \eand (I \eor D)$
%	\item $[(D \eif O) \eor A] \eand D$
%	\item \framebox{$[(A \eand B) \eand C] \eor (D \eor A)$}
%	\end{enumerate}
...
\item $(\script{A} \eand \script{B}) \eor \script{A}$							
	...
	\end{flushleft}
%
%(7) $(\script{A} \eand \script{B}) \eor \script{A}$							
%	\begin{flushleft}
%	\begin{enumerate}[label=\alph*.]
%	\item$((C \eif D) \eand E) \eor A$
%	\item \framebox{$(A \eand A) \eor A$}
%	\item \framebox{$((C \eif D) \eand E) \eor (C \eif D)$}
%	\item \framebox{$((G \eand B) \eand (Q \eor R)) \eor (G \eand B)$}
%	\item$(P \eor Q) \eand P$
%	\end{enumerate}
%	\end{flushleft}
...
\item $\script{P} \eif (\script{P} \eif \script{Q})$
	...
	\end{enumerate}
	\end{flushleft}
%\factoidbox{B, C and D}

%8) $\script{P} \eif (\script{P} \eif \script{Q})$
%	\begin{enumerate}[label=\alph*.]
%	\item $A \eif (B \eif C)$
%	\item \framebox{$(A \eand B) \eif [(A \eand B) \eif C]$}
%	\item \framebox{$(G \eif B) \eif [(G \eif B) \eif (G \eif B)]$}
%	\item \framebox{$M \eif [M \eif (D \eand (C \eand M)]$}
%	\item $(S \eor O) \eif [(O \eor S) \eif A]$
%	\end{enumerate}
...
\item $\enot \script{A} \eor (\script{B} \eand \enot \script{B})$
	...
	\end{enumerate}
	\end{flushleft}
%(9) $\enot \script{A} \eor (\script{B} \eand \enot \script{B})$
%	\begin{flushleft}
%	\begin{enumerate}[label=\alph*.]
%	\item $\enot P \eor (Q \eand \enot P)$
%	\item \framebox{$\enot A \eor (A \eand \enot A)$}
%	\item $(P \eif Q) \eor [(P \eif Q) \eand \enot R]$
%	\item $\enot E \eand (F \eand \enot F)$
%	\item \framebox{$\enot G \eor [(H \eif G) \eand \enot (H \eif G)]$}
%	\end{enumerate}
%	\end{flushleft}
...
%10)	$(\script{P} \eor \script{Q}) \eif \enot(\script{P} \eand \script{Q})$
%\begin{flushleft} 	
%\begin{enumerate}[label=\alph*.]
%	\item	$A \eif \enot B$
%	\item	\framebox{$(A \eor B) \eif \enot(A \eand B)$}
%	\item	\framebox{$(A \eor A) \eif \enot(A \eand A)$}
%	\item	\framebox{$[(A \eand B) \eor (D \eif E)] \eif $ \linebreak[4]$ \enot(A \eand B) \eand (D \eif E)]$}
%	\item	$(A \eand B) \eif \enot(A \eor B)$
%	\end{enumerate}
%\end{flushleft} 
\end{longtabu}
...
%$(\enot{C} \eif (A \eif B)) \eand \enot(B \eand C)$
\\
\item $\script{D} \eif (\script{B} \eand \enot \script{B}) $ 
%$\enot(B \eand C) \eif (\enot{C} \eand \enot \enot{C}) $
&
\item $\enot \enot (\script{C} \eor \script{E})$ 
%$\enot \enot ((A \eif B) \eor (D \eiff E))$
\\
\item $\enot \script{C} \eiff (\enot \enot \script{D} \eand \script{E})$ 
%$\enot (A \eif B) \eiff (\enot \enot \enot(B \eand C) \eand (D \eiff E))$
...
\itemc[.3] $(A \eand B) \eand C$
	\end{earg*}
%	\factoidbox{\begin{flushleft}Illegitimate Argument. You need the associativity of \eand to infer this.\end{flushleft}}
\\
\item %7
	\begin{earg*}
...
\item %3
	...
	\itemc[.3]$R$
	\end{earg*}
%	\factoidbox{\begin{flushleft}Illegitmate Argument. You need two uses of \eand-elim. to do this\end{flushleft}}
&
...
\begin{proof}
	\hypo{1}{W \eif \enot B}
	\hypo{2}{A \eand W}
	\hypo{2b}{B \eor (J \eand K)} \by{Want: $K$}{}
	\have{3}{W}{}
	\have{4}{\enot B} {}
	\have{5}{J \eand K} {}
	\have{6}{K}{}
...
%	\hypo{2}{A \eand W}
%	\hypo{2b}{B \eor (J \eand K)} \by{Want: $K$}{}
%	\have{3}{W}{} \by{\eand E,}{2}
%	\have{4}{\enot B} {} \by{\eif E,} {1,4}
%	\have{5}{J \eand K} {}\by{\eor E}{3,5}
%	\have{6}{K}{}\by{\eand E}{6}
%	\end{proof}
...
%	\hypo{1}{W \eand B}
%	\hypo{2}{E \eand Z} \by{Want: W \eand Z}{}
%	\have{3}{W} \by{\eand E}{1}
%	\have{4}{Z} \by{\eand E}{2}
%	\have{5}{W \eand Z} \by{\eand I}{3, 4}
%	\end{proof}
...
%	\begin{proof}
%	\hypo{1}{(A \eand B) \eand C} \by{Want: A \eand (B \eand C)}{}
%	\have{2}{A \eand B} \ae{1}
%	\have{3}{C} \ae{1}	
%	\have{4}{A} \ae{2}
%	\have{5}{B} \ae{2}
%	\have{6}{B \eand C} \ai{3,5}
%	\have{7}{A \eand (B \eand C)} \ai{4,6}	
%	\end{proof}
...
\begin{proof}
	...
	\have{4}{\nix{B}} \by{\eor E}{2, 3}
	\have{5}{\nix{\enot A \eand B}} \by{\eand I}{2, 4}
	\have{6}{\nix{C}} \by{\eif E}{1, 5}
	\end{proof} 
...
\vspace{-16pt}
	...
	\have{4}{\nix{\enot A}} \by{\eand E}{1}
	\have{5}{\enot B \eand C} \nix{\by{\eand E}{1}}
	\have{6}{\nix{\enot B}} \by{\eand E}{5}
	\have{7}{C} \nix{\by{\eand E}{5}}
	\have{8}{\nix{D \eand (B \eor E)}} \by{\eif E}{2, 7}
	\have{9}{D} \nix{\by{\eand E}{8}}
	\have{10}{\nix{B \eor E}} \by{\eand E}{8}
	\have{11}{E} \nix{\by{\eor  E}{6, 10}}
	\have[12]{12}{\nix{E \eand \enot A}} \by{\eand I}{4, 11}
	\have[13]{13}{F} \nix{\by{\eif E}{3, 12}}
	\have[14]{14}{\nix{D \eand F}} \by{\eand I}{9, 13}
	\end{proof}
...
\hypo{2}{B \eif (B \eif \enot A)} \by{Want: \enot A \eiff B}{}
	\open
	\hypo{3}{\enot A} \by{Want: \nix{B}}{}
	\have{4}{\nix{B}} \by{\eor E}{1, 3}
	\close
	\open
	\hypo{5}{B} \by{Want: \nix{\enot A}}{}
	\have{6}{B \eif \enot A} \nix{\by{\eif E}{2, 3}}
	\have{7}{\nix{\enot A}} \by{\eif E}{5, 6}
	\close
\have{8}{\enot A \eiff B} \nix{\by{\eiff I}{3-4, 5-7}}
\end{proof}
\end{exercises}
...
%4) $X \eiff (A \eand B)$, $B \eiff Y$, $B \eif A$  $\therefore$ $X \eiff Y$
%
%\begin{proof}
...
\item $\{K\} \sststile{}{} S \eif (T \eif S)$

%4)  $\{K \sststile{}{} S \eif (T \eif S)$
%
%\begin{proof}
%\hypo{1}{K} \by{Want: $S \eif (T \eif S)$}{}
%	\open
%	\hypo{2}{S} \by{Want: $T \eif S$}{}
%		\open
%		\hypo{3}{T}\by{	Want: $S$}{}
%		\have{4.}{S} \by{R}{2}
%		\close
%	\have{5.}{T \eif S} \by{\eif I}{3-4}
%	\close
%\have{6.}{S \eif (T \eif S)} \by{\eif I}{2-5}
%\end{proof}

%Appears in: Hurley 10, p. 401
%used in your text, replace ASAP.



\item $\{\enot W \eand \enot E, Q \eiff D\} \sststile{}{} (W \eor Q) \eiff (E \eor D)$

%5) \enot W \eand \enot E, Q \eiff D $\therefore$ (W \eor Q) \eiff (E \eor D)
%
%\begin{proof}
...
%
%2)  $A\eif (B\eif C)$ $\therefore$ $(A\eand B)\eif C$
%\begin{proof}
...
\item $\{M \eif  (K \eif L), (L \eor N) \eif J \} \sststile{}{} M \eif (K \eif J)$

%	1.	M → (K → L)
%2.	(L v N) → J 			Want: M → (K → J)
%3.		M				Want: K → J
%4.			K			Want J
%5.			K → L		→E, 1, 3
%6.			L			→E, 4, 5
...
%taken from Hurley, replace ASAP


\item $\{\enot A, (B \eand C) \eif D\} \sststile{}{}(A \eor B) \eif (C \eif D)$

%5) $\enot A$, $(B \eand C) \eif D$ $\therefore$ $(A \eor B) \eif (C \eif D)$
%\begin{proof}
%
%\hypo{1}{\enot A}
...
\item $\{(K \eif K) \eif R, (R \eor M) \eif N \sststile{}{} N$
...
%
%Appears in: Hurley 10, p. 401
%Now it your text, replace ASAP


\item $\{(A \eand B) \eiff D, D \eiff (X \eand Y), C \eiff Z\} \sststile{}{} A \eand (B \eand C) \eiff X \eand (Y \eand Z)$
%
%7) $(A \eand B) \eiff D, D \eiff (X \eand Y), C \eiff Z $\therefore$ A \eand (B \eand C) \eiff X \eand (Y \eand Z)$
%
%\begin{proof}
...
\label{DeM2}
\begin{proof}
\hypo{1}{\enot A \eand \enot B} \by{Want: }{}
\have{2}{\enot A} 
\have{3}{\enot B} 
\open
...
%\begin{proof}
%\hypo{1}{\enot A \eand \enot B} \by{Want: \enot (A \eor B)}{}
%\have{2}{\enot A} \ae{1}
%\have{3}{\enot B} \ae{2}
%\open
%	\hypo{4}{A \eor B} \by{for reductio}{}
%	\have{5}{B} \oe{2, 4}
%	\have{6}{\enot B} \by{R}{3}
%\close
%\have{7}{\enot(A \eor B)} \ni{4-6}
%\end{proof}
...
\hypo{1}{\enot A \eor \enot B} \by{Want: $\enot(A \eand B)$}{}
	...
	\have{3}{\hspace{1cm}} \ae{2}	
	\have{4}{} \ae{2}
		\open
		\hypo{5}{\hspace{1cm}} \by{for reductio}{}
		\have{6}{} \by{R}{3}
		\have{7}{} \by{R}{5}
		\close
	\have{8}{\enot \enot A} 
...
%\open
%\have{3.}{\enot (T \eand K)} \by{For Reductio}{}
...
\begin{proof}
	...
	\have{n}{(P \eor M) \eif (M \eand P)}\by{Comm\eand}{2}
\end{proof}
...
\begin{multicols}{2}
\begin{sortedlist}
\sortitem{Syntactically logically equivalent in SL}{}
\sortitem{Syntactic tautology in SL}{}
\sortitem{Syntactic contradiction in SL}{}
\sortitem{Syntactically contingent in SL}{}
\sortitem{Syntactically inconsistent in SL}{}
\sortitem{Syntactically consistent in SL}{}
\sortitem{Syntactically valid in SL}{}
\sortitem{Soundness}{}
\sortitem{Completeness}{} 	
\end{sortedlist}
\end{multicols}
