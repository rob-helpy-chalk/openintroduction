...
{
name=distribution,
description={A property of the subject and predicate class of a categorical statement that is present when the statement makes a claim about the whole class.}
}
...
description={An aspect of the meaning of a statement that which means that the statement can only be true if the objects it describes exist.}
}
