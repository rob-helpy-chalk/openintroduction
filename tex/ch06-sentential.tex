...
Consider these examples of sentences that use the English-language connective ``unless'':
...
Sentence \ref{if1} can be translated partially as ``If $R$, then $B$.'' 
...
\subsection{Combining negation and disjunction}
